...
const prestonForecastApiURL = 'https://api.openweathermap.org/data/2.5/forecast?id=5604473&appid=a3a248601a9f69327684ea06f341d4bb&units=metric';
const sodaSpringsForecastApiURL = 'https://api.openweathermap.org/data/2.5/forecast?id=5678757&appid=a3a248601a9f69327684ea06f341d4bb&units=metric';
const fishHavenForecastApiURL = 'https://api.openweathermap.org/data/2.5/forecast?id=5585010&appid=a3a248601a9f69327684ea06f341d4bb&units=metric';

var apiURL = "";

if (document.getElementById('page-tag').textContent == "pt"){
    apiURL = prestonForecastApiURL;
  } 
  else if (document.getElementById('page-tag').textContent == "sp"){
    apiURL = sodaSpringsForecastApiURL;
  }
  else if (document.getElementById('page-tag').textContent == "fh"){
    apiURL = fishHavenForecastApiURL;
  }
